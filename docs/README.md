...
| **[CAMPAIGN_SIM.md](./CAMPAIGN_SIM.md)** | Hướng dẫn chạy `tools/balance-sim.js` để kiểm tra campaign 12 màn, Tinh Thạch, mở khoá tướng, farm màn cũ và cổng khắc chế. |
...
- ✅ **Campaign sim:** đã có mô phỏng nhanh cho 12 màn để kiểm tra Tinh Thạch, mở khoá tướng và tường độ khó.
- ⏭️ **Đang ở khâu cân bằng campaign:** chạy sim + playtest tay, chỉnh các màn bị wall quá sớm, sau đó mới thêm tướng/quái mới.
